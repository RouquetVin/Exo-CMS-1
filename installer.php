...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221207_gamingsurprise_ca76a2e4cf63d5387900_20221207125644_archive.zip';
        const ARCHIVE_SIZE       = '76075904';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'ca76a2e-07125644';
        const SECONDARY_PACKAGE_HASH = 'fcd79ba-07125644';
        const VERSION            = '1.5.1';
